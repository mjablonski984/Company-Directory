<?php
	...
	if (isset($_POST) ) {
		...
		if (empty($_POST['id'])|| empty($_POST['firstName']) || empty($_POST['lastName']) || empty($_POST['email']) || empty($_POST['departmentID'])){
		exit;
		}
        ...
        $query = "UPDATE personnel SET firstName='$firstName', lastName='$lastName', email='$email', jobTitle='$jobTitle', departmentID='$departmentID' WHERE id=$id";
